...
const PaymentHistoryPage = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto my-12 p-8 bg-white rounded-xl shadow-lg font-sans mt-20'>
            <h1 className='text-3xl font-bold text-gray-800 mb-8 text-center'>Lịch sử giao dịch Coin</h1>
            ...
            <div className='mb-8 p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-200'>
                ...
                <div className='mt-6 text-center'>
                    <PrimaryButton onClick={handleSearch} disabled={loading} className='px-8 py-3 text-lg'>
            ...
            {loading ? (
                <div className='flex items-center justify-center h-32'>
                    <p className='text-lg font-medium text-gray-800 animate-pulse'>Đang tải lịch sử giao dịch...</p>
                </div>
            ) : error ? (
