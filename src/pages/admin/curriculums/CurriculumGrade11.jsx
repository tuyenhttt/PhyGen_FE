...
const CurriculumGrade11 = () => {
    ...
    return (
        <div className="flex-1 p-6 bg-gray-100 min-h-screen">
            <h2 className="text-2xl font-bold text-gray-800 tracking-tight mb-5">Khung chương trình Vật lý Lớp 11</h2>
...
export default CurriculumGrade11;