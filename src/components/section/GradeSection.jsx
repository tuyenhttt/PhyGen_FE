...
const GradeSection = ({
  ...
  return (
    <div className='mb-8 p-6 bg-white rounded-xl shadow-lg border border-gray-200'>
      <div
        className='flex justify-between items-center mb-4 pb-2 border-b border-gray-200 cursor-pointer'
        onClick={toggleGrade}
      >
        <h3 className='text-xl font-bold text-gray-900'>Vật lý Lớp {grade}</h3>
